<template>
    <div class="sidebar overflow-y-auto overflow-x-hidden h-full shadow-md bg-white absolute dark:bg-slate-800 border-b border-gray-100 dark:border-slate-500">
