<nav x-data="{ open: false }" class="bg-white dark:bg-slate-700 border-b border-gray-100 dark:border-slate-500">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex dark:text-slate-400">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        ...
                        dark:focus:border-gray-300 transition duration-150 ease-in-out">
                            <div>{{ Auth::user() ? Auth::user()->name : "Welcome Guest!" }}</div>
